...
public class GeofenceTransitionsIntentService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if (geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
            ...
            String geofenceTransitionDetails = getGeofenceTransitionDetails(getApplicationContext(), geofenceTransition, triggeringGeofences);
     ...
     * If the user clicks the notification, control goes to the FlipperViewActivity.
     */
    private void sendNotification(String notificationDetails) {
        // Create an explicit content Intent that starts the main Activity.
        Intent notificationIntent = new Intent(getApplicationContext(), FlipperViewActivity.class);

        // Construct a task stack.
        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);

        // Add the main Activity to the task stack as the parent.
        stackBuilder.addParentStack(FlipperViewActivity.class);
